<template>
	<view style="height: 100vh;margin: 32upx;">
		<view style="text-align: center;background: #FFFFFF;padding: 40upx;border-radius: 32upx;">
			...
			<view @click="copyHref" style="width:200upx;margin-top: 32upx;font-size: 30upx;margin-left: 30%;color: #FFFFFF;background: #e10a07;padding: 4upx 20upx;border-radius: 24upx;">一键复制</view>
